...
const TeacherDashboard = () => {
  ...
  const AddTeacher = () => {
    try {
         ...
         toast.success("Proctoring added successfully")
    } catch (error) {
  ...
  const onDeleteTeacher = (data) => {
    ...
    try {
      ...
      toast.error("Error deleting proctoring")
    }
  ...
  const restoreTeacher = (data) => {
    ...
    try {
          dispatch(deleteTeacher(req))
          toast.success("Proctoring restored successfully")
    } catch (error) {
      toast.error("Error restoring proctoring ")
    }
try {
      setTimeout(() => dispatch(getAllTeachers(param)), 1000)
} catch (error) {
