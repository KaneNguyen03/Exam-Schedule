      ...
      <div></div>
        <div className="flex space-x-3">
          <img
            ...
            alt="ESM"
          />
          <div className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Exam Schedule Manage </div>
        </div>
        <div className="border-solid border-5 border-sky-500 text-xl">
